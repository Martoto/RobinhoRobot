...
<div align="center">
  ...
  <h3 align="center">Educational robotic arena web interface</h3>

  <p align="center">
    Robinho is a novel concept for robotics education, including a intelligent reprogramable robot buil from scratch and a lightweight web client that can be hosted in any old PC.
This project also encompasses communications for all components coordinated through a flask webserver.
    <br />
  </p>
</div>
